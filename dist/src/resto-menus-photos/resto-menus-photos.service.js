...
let RestoMenuPhotosService = class RestoMenuPhotosService {
    ...
    async updateRestoMenuPhotos(id, data) {
        const result = await this.restoMenusPhotosRepository.update({
            rempId: id,
        }, {
            rempThumbnailFilename: data.rempThumbnailFilename,
            rempPhotoFilename: data.rempPhotoFilename,
...
RestoMenuPhotosService = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(RestoMenuPhotos_1.RestoMenuPhotos)),
    __metadata("design:paramtypes", [typeorm_1.Repository])
], RestoMenuPhotosService);
exports.RestoMenuPhotosService = RestoMenuPhotosService;
//# sourceMappingURL=resto-menus-photos.service.js.map